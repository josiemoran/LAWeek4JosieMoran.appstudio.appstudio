...
const cacheName = 'LAWeek4JosieMoran_appstudio-2021-02-24 16:04:54.708280'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4JosieMoran_appstudio'.length) === 'LAWeek4JosieMoran_appstudio') {
